...
4) Once installed, go to the folder containing the cloned Github repo (if you see the W3-ASP.NET-Core-Web-App.sln file, you are in the correct place) and open cmd (just write cmd in the the location bar of Windows Explorer).
